export default {
  props: {
    ...
    tabletImg: 'https://www.lexus.com/cm-img/performance/landing/05/Lexus-Performance-Hero-Tablet-960x469_M75.jpg',
    mobileImg: 'https://www.lexus.com/cm-img/performance/landing/05/Lexus-Performance-Hero-Mobile-640x700_M75.jpg',
    cta: [ 'PLAY VIDEO', 'SEE ALL MODELS' ],
